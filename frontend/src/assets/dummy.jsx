...
export const BUTTON_CLASSES =
    "w-full bg-blue-600 text-white text-sm font-semibold py-2.5 rounded-lg hover:bg-blue-700 hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"

// PROFILE CSS
export const INPUT_WRAPPER =
    "flex items-center border border-blue-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-all duration-200"
export const FULL_BUTTON =
    "w-full bg-blue-600 text-white py-2.5 rounded-lg hover:bg-blue-700 hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"
...
export const PRODUCTIVITY_CARD = {
    ...
    barFg: "h-full bg-gradient-to-r from-blue-600 to-indigo-600 animate-pulse",
}

export const TIP_CARD = {
    container: "bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100",
...
export const ADD_BUTTON =
    "flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg shadow-sm hover:bg-blue-700 hover:shadow-md transition-all duration-200 w-full md:w-auto justify-center text-sm md:text-base"
...
export const EMPTY_STATE = {
    ...
    btn: "px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700",
}
...
export const TAB_INACTIVE = "text-gray-600 hover:bg-blue-100/50 hover:text-blue-700"
...
export const TI_CLASSES = {
    ...
    progressBarFg: "h-full bg-gradient-to-r from-blue-600 to-indigo-600 transition-all duration-300",
